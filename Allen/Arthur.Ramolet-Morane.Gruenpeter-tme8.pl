...
afficheI([],_).
afficheI([rel(A,B,C)|_],I):-A=I,write(rel(A,B,C)).
afficheI([rel(A,B,C)|_],I):-B=I,write(rel(A,B,C)).

afficheI([rel(A,B,C)|Q],I):-afficheI(Q,I).
affiche((_,R),I):-afficheI(R,I).



%2.6
/*Les intervalles: gardien, jardinier,paul1(le chauffeur), paul2(le chauffeur), francoise, louis, apprentiJ, pierre, bernardMort, bernardfaitsigne, alertePolice*/
leMeurtre :- creationGraphe(
		[rel(bernardMort,alertPolice, [<]),
		rel(bernardMort,bernardfaitsigne, [>]),
		rel(alertPolice,paul2, [d]),
		rel(alertPolice,pierre, [d]),
		rel(alertPolice,louis, [d]),
		rel(gardien,jardinier, [d,o,e]),
		rel(jardinier,paul1, [d]),
		
		rel(paul1,francoise, [<]),
		rel(francoise,louis, [o]),
		rel(francoise,jardinier, [d]),
		rel(francoise,apprentiJ, [o]),
		rel(louis,apprentiJ, [d,o,e]),

		rel(bernardfaitsigne,apprentiJ, [d]),
		rel(bernardfaitsigne,jardinier, [d]),
		rel(bernardfaitsigne,francoise, [d]),			

		rel(francoise,pierre, [<]),
		rel(pierre,paul2, [=,s])],G),
